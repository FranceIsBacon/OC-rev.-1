...
// Error
$_['error_required']       = 'Uwaga: All payment information fields are required.';
$_['error_general']        = 'Uwaga: A general problem has occurred with the transaction. Please try again.';
$_['error_config']         = 'Uwaga: Payment module configuration error. Please verify the login credentials.';
$_['error_address']        = 'Uwaga: A match of the Adres płatności Miasto, State, and Postal Code failed. Please try again.';
$_['error_declined']       = 'Uwaga: This transaction has been declined. Please try again.';
$_['error_invalid']        = 'Uwaga: The provided credit card information is invalid. Please try again.';
?>