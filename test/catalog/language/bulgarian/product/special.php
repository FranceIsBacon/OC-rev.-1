<?php
// Heading
$_['heading_title']     = 'Специални оферти';

// Text
$_['text_empty']        = 'Няма налични специални оферти.';
$_['text_quantity']     = 'К-во:';
$_['text_manufacturer'] = 'Производител:';
$_['text_model']        = 'Код на продукт:'; 
$_['text_points']       = 'Бонус точки:'; 
$_['text_price']        = 'Цена:'; 
$_['text_tax']          = 'с ДДС:'; 
$_['text_reviews']      = 'Базирано на %s коментара.'; 
$_['text_compare']      = 'Сравнение на продукт (%s)'; 
$_['text_display']      = 'Показване:';
$_['text_list']         = 'Списък';
$_['text_grid']         = 'Икони';
$_['text_sort']         = 'Сортиране по:';
