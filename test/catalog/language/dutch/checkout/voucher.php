...
$_['text_description'] = 'Zodra u heeft afgerekend wordt de cadeaubon naar de ontvanger verstuurt.';
$_['text_agree']       = 'Ik ga ermee akkoord dat het aankoopbedrag van deze bon niet kan worden teruggestort.';
$_['text_message']     = '<p>Bedankt voor het kopen van een cadeaubon! Zodra u voor de bon heeft betaald wordt deze verstuurd naar de ontvanger, inclusief instructies voor het gebruik van de bon.</p>';
...
$_['entry_amount']     = 'Bedrag:<br /><span class="help">Het bedrag van deze cadeaubon moet hoger zijn dan 1 euro en lager dan 1000 euro</span>';
$_['entry_theme']      = 'Gelegenheid:<br /><span class="help">Voor welke gelegenheid krijgt de ontvanger deze cadeaubon.</span>';
...
$_['error_amount']     = 'Bedrag moet tussen de %s en %s!';
$_['error_theme']      = 'Wilt u a.u.b. een gelegenheid selecteren?';
$_['error_agree']      = 'U moet akkoord gaan met de voorwaarden van cadeaubonnen!';
?>